...
# WORKFLOW
# 1. GET DATA
# 2. COMPUTING INDIVIDUAL CORRELATIONS
# 3: SAMPLE FINAL OUTPUT: CORRGRAMS
# 4: SAMPLE FINAL OUTPUT: CORRGRAMS WITH P-VALUES
...
# correlation between DRB and ORB
cor(nba$DRB, nba$ORB) # 0.846

# check significance level (e.g., get p-value) & get confidence intervals 
cor.test(nba$DRB, nba$ORB) # p-value = 0.00000000000001
